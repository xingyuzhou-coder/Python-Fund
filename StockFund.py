...
# 读取excel中基金的代号
def read_excel_code():
    stockfund_code=pd.read_excel(r'/Users/zhouxingyu/Library/Mobile Documents/com~apple~CloudDocs/Xingyu Zhou/[5] Financial/投资数据库/Excel文档/金融资产配置文档.xlsx',usecols=[3],dtype=str,sheet_name="股票基金投资资产")
    stockfund_code_list=stockfund_code.values.tolist()
    print (stockfund_code_list)
    return stockfund_code_list
